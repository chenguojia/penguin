...
(function () {
    ...
    window.Framework7 = function (params) {
        ...
        app.params = {
            ...
            // Modals
            modalButtonOk: '确定',
            modalButtonOkPos: '有POS机',
            modalIKnow: '我知道了',
            modalButtonCancel: '取消',
            modalButtonCancelPos: '无POS机',
        ...
        app.pageInitCallback = function (view, params) {
            ...
            if (params.fromPage && !params.fromPage.navbarInnerContainer && params.oldNavbarInnerContainer) {
                //if (typeof(params) != "undefined")
                    params.fromPage.navbarInnerContainer = params.oldNavbarInnerContainer;v
            }
        ...
        ************   Modals   ************
        ...
        app.alert1 = function (text, title, callbackOk) {
            if (typeof title === 'function') {
                callbackOk = arguments[1];
                title = undefined;
            }
            return app.modal({
                text: text || '',
                title: typeof title === 'undefined' ? app.params.modalTitle : title,
                buttons: [ {text: app.params.modalIKnow, bold: true, onClick: callbackOk} ]
            });
        };
        ...
        app.confirm1 = function (text, title, callbackOk, callbackCancel) {
            if (typeof title === 'function') {
                callbackCancel = arguments[2];
                callbackOk = arguments[1];
                title = undefined;
            ...
            return app.modal({
                ...
                title: typeof title === 'undefined' ? app.params.modalTitle : title,
                buttons: [
                    {text: app.params.modalButtonOkPos, bold: true, onClick: callbackOk},
                    {text: app.params.modalButtonCancelPos, onClick: callbackCancel}
                ]
            });
        };
