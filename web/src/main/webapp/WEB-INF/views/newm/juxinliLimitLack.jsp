            ...
            <div class="navbar login-title">
                <div class="navbar-inner">
                    ...
                    <%--<div class="left"><a href="#" class="close-img"><img src="<c:url value='/resources/image/left-arror.png'/>"></a></div>--%>
                        <div class="login-title-word" style="margin-left: 30%; position: absolute; margin-top: 13px;">手机验证</div>
                </div>
            </div>
                                 ...
                                 <ul>
                                     ...
                                     <li class="item-content">
                                         <div class="item-inner">
                                             ...
                                             <div class="item-input">
                                                 <input type="text"  name="mobilePhone" id="mobilePhone" placeholder="请输入手机号码"  value="${newMerchantUserModel.mobilePhone}" maxlength="20"/>
                                             </div>
                                         </div>
                                     </li>
                                     <li class="item-content">
