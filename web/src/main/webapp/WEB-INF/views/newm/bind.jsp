...
<!-- Views-->
<div class="views" id="register">
    <!-- Your main view, should have "view-main" class-->
    <div class="view view-main">
        <!-- Top Navbar-->
        <div class="navbar login-title">
            <div class="navbar-inner">
                <div class="left"><a href="<c:url value='/new/m/login/show'/>" class="close-img"><img
                        src="<c:url value="/resources/image/left-arror.png"/>"></a></div>
                <div class="center sliding login-title-word">新用户注册</div>
            </div>
        </div>
                ...
                <div class="page-content">
                        ...
                        <div class="list-block register-home">
                            <ul>
                                <li class="item-content border-bottom border-tops">
                                    ...
                                    <div class="item-inners">
                                        <div class="item-title">
                                            <input class="login_input" type="number" maxlength="11" id="mobile"
                                ...
                                <li class="item-content border-bottom">
                                    <div class="item-media">
                                        <span class="icon username_icon pinCode"><img
                                ...
                                <li class="item-content border-bottom">
                                    ...
                                    <div class="item-inners">
                                        <div class="item-title">
                                            <input class="login_input" type="password" id="password" maxlength="16"
                                                   placeholder="请输入6-16位初始密码">
                                        </div>
                                    </div>
                                </li>
                            </ul>
                            <ul class="register-home-part2">
                                <li class="item-content border-bottom border-tops">
                                    ...
                                    <div class="item-inners">
                                        <div class="item-title">
                                            <input class="login_input" type="text" id="inviteCode" name="inviteCode" maxlength="16"
                                                   placeholder="邀请码">
                                        </div>
                                    </div>
                                </li>
                    ...
                    <div class="padding-rl15 margin-t-5">
                        ...
                        <div class="bind-number-new">
                            ...
                            <a class="button button-big button-fill apply-button" href="#" id="submitBtn">注册</a>
                        </div>
                    </div>
                </div>
            </div>
...
//                            location.href = contextPath + "new/m/accredit/show";//未同意条款
    ...
    //        "mobile": $("#mobile").val(), "code":$("#code").val(),"timestamp":timestamp
