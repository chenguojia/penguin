    ...
    <div class="view view-main">
        ...
        <div class="navbar login-title">
            <div class="navbar-inner">
                <%--<div class="left"><a href="<c:url value='${sourceType == "1" ? "/new/m/home" :"/new/m/applyStatus/show"}  '/>" class="close-img"><img src="<c:url value='/resources/newm/images/icon/select-arrow.png'/>"></a></div>--%>
                ...
                <div class="page-content margin-t05">
                    <div>
                        ...
                        <c:forEach var="item" items="${uploadFileMainModels}">
                            <div class="content-block-title addFiles-font1">
